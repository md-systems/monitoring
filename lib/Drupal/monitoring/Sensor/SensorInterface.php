...
interface SensorInterface {
   ...
   *    will then be used as is, should include all relevant information.
   ...
   * which means that it will attempt to set the sensor status if not already
   ...
   *
   * An unknown sensor status can either be set based on an expected value or
   ...
   * expected value, thresholds, the configured time span and status messages.
   ...
   * no value nor status messages are provided, the message will default to
   * "No value".
   *
